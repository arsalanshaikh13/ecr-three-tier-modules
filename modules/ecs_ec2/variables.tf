...
variable "backend_api_name" {
  description = "Name for backend api ."
  type        = string
}
...
variable "ec2_provider_backend_name" {
  description = "Name for ec2 provider backend name."
  type        = string
}

variable "ec2_provider_frontend_name" {
  description = "Name for ec2 provider frontend name."
  type        = string
}
