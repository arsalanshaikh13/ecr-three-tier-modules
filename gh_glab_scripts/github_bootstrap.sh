...
# git add .;
# git commit -m "creating private subnets for db subnet group in vpc itself instead of nat";
# git push
# git tag -d 0.0.6-db-vpc-pri_sub
# git push origin --delete 0.0.6-db-vpc-pri_sub
